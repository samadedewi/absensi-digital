...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-white">Tambah Mahasiswa</h1>
        <p class="text-slate-400 text-sm mt-1">Masukkan data mahasiswa baru untuk membuat QR Code.</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        <input type="text" name="nim" id="nim" class="block w-full rounded-xl py-3 px-4 border bg-slate-900/50 border-white/10 text-white focus:border-cyan-500 outline-none transition-all @error('nim') border-red-500 text-red-400 @enderror" value="{{ old('nim') }}" required>
                    </div>
                    @error('nim')
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        <input type="text" name="name" id="name" class="block w-full rounded-xl py-3 px-4 border bg-slate-900/50 border-white/10 text-white focus:border-cyan-500 outline-none transition-all @error('name') border-red-500 text-red-400 @enderror" value="{{ old('name') }}" required>
                    </div>
                    @error('name')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <!-- Photo -->
                <div>
                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 ml-1">Foto Profil (Opsional)</label>
